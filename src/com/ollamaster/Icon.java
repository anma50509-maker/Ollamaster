...
public final class Icon {
    ...
    static {
        ...
        P.put("chevronRight", "M8.59,16.59L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.59Z");
        ...
        // 档位/参数调节（三条滑轨 + 滑块）
        P.put("sliders", "M6.5,3C5.12,3 4,4.12 4,5.5S5.12,8 6.5,8 9,6.88 9,5.5 7.88,3 6.5,3zM4,10v4h5v-4H4zM4,16v3h5v-3H4zM11,2v3h9V2h-9zM11,7v4h9V7h-9zM11,12v4h9v-4h-9zM11,17v3h9v-3h-9z");
        // 终端提示符（右向小箭头，空白友好）
        P.put("caret", "M9,6L15,12L9,18L7.59,16.59L12.17,12L7.59,7.41L9,6Z");
